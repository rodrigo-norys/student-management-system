...
| Name                    | Type         | Settings                             | References                                           | Note |
| ----------------------- | ------------ | ------------------------------------ | ---------------------------------------------------- | ---- |
| **id**                  | INTEGER      | 🔑 PK, not null, autoincrement       | fk_students_id_addresses, fk_students_id_attendances |      |
...
| **is_active**           | ENUM         | not null, default: active            |                                                      |      |
| **created_at**          | DATETIME     | not null, default: CURRENT_TIMESTAMP |                                                      |      |
| **updated_at**          | DATETIME     | not null, default: CURRENT_TIMESTAMP |                                                      |      | 
...
| unit_classes_index_1 |        | unit_id, name, school_year               |
| unit_classes_index_2 |        | grade_level                              |
### staff
...
| subjects_index_2 |        | knowledge_area |
### class_allocations

| Name              | Type     | Settings                             | References                                    | Note |
| ----------------- | -------- | ------------------------------------ | --------------------------------------------- | ---- |
| **id**            | INTEGER  | 🔑 PK, not null, autoincrement       | fk_class_allocations_id_attendances           |      |
...
| **subject_id**    | INTEGER  | not null                             | fk_class_schedules_subjects_id_subjects       |      |
| **is_active**     | TINYINT  | not null, default: 1                 |                                               |      |
| **created_at**    | DATETIME | not null, default: CURRENT_TIMESTAMP |                                               |      |
| **updated_at**    | DATETIME | not null, default: CURRENT_TIMESTAMP |                                               |      | 
...
| Name                      | Unique | Fields                    |
| ------------------------- | ------ | ------------------------- |
| class_allocations_index_0 | ✅      | unit_class_id, subject_id |
| class_allocations_index_1 |        | staff_id                  |
### student_guardians
...
| student_guardians_index_1 |        | student_id  |
### staff_units

| Name           | Type     | Settings                             | References                    | Note |
| -------------- | -------- | ------------------------------------ | ----------------------------- | ---- |
| **id**         | INTEGER  | 🔑 PK, not null, autoincrement       |                               |      |
| **staff_id**   | INTEGER  | not null                             | fk_staff_units_staff_id_staff |      |
| **unit_id**    | INTEGER  | not null                             | fk_staff_units_unit_id_units  |      |
| **is_active**  | TINYINT  | not null, default: 1                 |                               |      |
| **created_at** | DATETIME | not null, default: CURRENT_TIMESTAMP |                               |      |
| **updated_at** | DATETIME | not null, default: CURRENT_TIMESTAMP |                               |      | 
...
| staff_units_index_1 |        | staff_id, unit_id |
### student_classes
...
| **enrollment_status** | ENUM     | not null, default: active            |                                               |      |
...
| student_classes_index_1 |        | unit_class_id             |
### student_grades
...
| **subject_status**      | ENUM         | not null, default: studying          |                                                      |      |
...
| Name                | Unique | Fields                                |
| ------------------- | ------ | ------------------------------------- |
| attendances_index_0 |        | student_id, class_allocation_id, date |
| attendances_index_1 |        | date                                  |
## Relationships
...
- **students to attendances**: one_to_many
- **class_allocations to attendances**: one_to_many
...
erDiagram
	...
	students ||--o{ attendances : references
	class_allocations ||--o{ attendances : references

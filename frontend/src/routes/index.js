  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/guardians" element={<MyRoute isClosed><Guardians /></MyRoute>} />
        <Route path="/guardian/create" element={<MyRoute isClosed><Guardian /></MyRoute>} />
        <Route path="/guardian/:id/edit" element={<MyRoute isClosed><Guardian /></MyRoute>} />

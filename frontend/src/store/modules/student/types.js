...
export const GET_STUDENT_REQUEST = 'GET_STUDENTS_REQUEST';
export const GET_STUDENT_SUCCESS = 'GET_STUDENTS_SUCCESS';
export const GET_STUDENT_FAILURE = 'GET_STUDENTS_FAILURE';
